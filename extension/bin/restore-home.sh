...
sudo dnf install --assumeyes rsync dvdisaster genisoimage &&
    ...
    do
        aws s3 cp s3://hp-pavillion/home.tar.gz.0${I}.gpg.iso hp-pavillion/home.tar.gz.0${I}.gpg.iso &&
            docker container run --interactive --rm --volume $(pwd):hp-pavillion/in:ro --volume /srv/host/home/user:/out alpine:3.4 cp /in/hp-pavillion/home.tar.gz.0${I}.gpg.iso /out/home.tar.gz.0${I}.gpg.iso &&
